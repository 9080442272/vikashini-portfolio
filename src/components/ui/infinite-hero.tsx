    ...
    <div ref={rootRef} className="relative h-svh w-full overflow-hidden bg-black text-white">
      ...
      <div className="relative z-10 flex h-svh w-full items-center justify-center px-6">
        <div className="text-center">
          ...
          >
            Hi, I’m Vikashini — a Product Designer focused on simplifying complex workflows.
          </h1>
          <p
            ref={pRef}
            className="mx-auto mt-4 max-w-2xl md:text-balance text-sm/6 md:text-base/7 font-light tracking-tight text-white/70"
          >
            I design digital products that remove friction, cut unnecessary steps, and make everyday interactions feel
            obvious—not learned. I approach design with a practical mindset: understand the real problem, challenge
            assumptions, and deliver interfaces that actually improve how people work, not just how things look.
          </p>
